...
import {ArrowRightIcon, CheckIcon, Code2Icon, Dumbbell, UsersIcon, VideoIcon, ZapIcon} from "lucide-react"
function HomePage() {
  return (
    <div className='bg-gradient-to-br from-base-100 via-base-200 to-base-300'>
        <nav className='bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg'>
        <div className='max-w-7xl mx-auto p-4 flex items-center justify-between'>
            <Link to={"/"} className='flex items-center gap-3 hover:scale105 transition-transform duration-200'>
               ...
               <div className='flex flex-col'>
                ...
                <SignInButton mode='modal'>
                    <button className='group px-6 py-3 bg-gradient-to-r from-primary to-secondary
                     rounded-xl text-white font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2'>
